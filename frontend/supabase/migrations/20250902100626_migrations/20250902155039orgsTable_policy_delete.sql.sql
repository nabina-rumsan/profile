...
alter table "public"."orgs" add constraint "orgs_owner_id_fkey" FOREIGN KEY (owner_id) REFERENCES auth.users(id) not valid;
...
alter table "public"."profiles" add constraint "profiles_org_id_fkey" FOREIGN KEY (org_id) REFERENCES orgs(id) ON DELETE SET NULL not valid;
...
create policy "Any authenticated user can view orgs"
on "public"."orgs"
as permissive
for select
to authenticated
...
create policy "Users can create orgs for themselves"
on "public"."orgs"
as permissive
for insert
to authenticated
...
create policy "Users can delete their own orgs"
on "public"."orgs"
as permissive
for delete
to authenticated
...
create policy "Users can update their own orgs"
on "public"."orgs"
as permissive
for update
to authenticated
...
create policy "Any authenticated user can view any post"
on "public"."posts"
as permissive
for select
to authenticated
